...
| Israel | [Israel Government Data Portal](https://data.gov.il/dataset/covid-19) | [Attribution Required](https://data.gov.il/terms) | L2 regions are provided by the source and are aggregated to L1. The total vaccination dose numbers provided by the source for L2 do not match the country-wide total. This also impacts the aggregated L1 totals. |
