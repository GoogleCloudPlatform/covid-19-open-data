...
OUTPUT_COLUMN_ADAPTER = {
    ...
    "total_persons_vaccinated_pfizer": "cumulative_ersons_vaccinated_pfizer",
    "total_persons_fully_vaccinated_pfizer": "cumulative_ersons_fully_vaccinated_pfizer",
    "total_vaccine_doses_administered_pfizer": "cumulative_accine_doses_administered_pfizer",
    "total_persons_vaccinated_moderna": "cumulative_ersons_vaccinated_moderna",
    "total_persons_fully_vaccinated_moderna": "cumulative_ersons_fully_vaccinated_moderna",
    "total_vaccine_doses_administered_moderna": "cumulative_accine_doses_administered_moderna",
    "total_persons_vaccinated_janssen": "cumulative_ersons_vaccinated_janssen",
    "total_persons_fully_vaccinated_janssen": "cumulative_ersons_fully_vaccinated_janssen",
    "total_vaccine_doses_administered_janssen": "cumulative_accine_doses_administered_janssen",
    # Demographics table
